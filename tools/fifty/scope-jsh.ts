		...
		$export(
			function(scope) {
				var file = {
					...
					mock: {
						fixtures: function() {
							var script: slime.runtime.loader.Scoped<slime.jrunscript.file.internal.mock.Context,slime.jrunscript.file.mock.Fixtures> = $loader.script("../../rhino/file/mock.fixtures.ts");
							return script({
								library: {
									java: jsh.java,
									io: jsh.io
