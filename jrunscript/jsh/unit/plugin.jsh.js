...
(
	...
	function(Packages,$slime,$api,jsh,$loader,plugin) {
		...
		plugin({
			...
			load: function() {
				var code = {
					/** @type { slime.jsh.unit.internal.remote.Script } */
					remote: $loader.script("remote.js")
				};
		...
		plugin({
			...
			load: function() {
				...
				var script = $loader.script("plugin.jsh.browser.js");
				var $exports = script({
					jsh: jsh
				});
				...
				jsh.unit.interface.Chrome = function(p) {
					...
					var rv = Chrome(jsh.js.Object.set({}, p, {
