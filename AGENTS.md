...
[~/.agents](/config/.agents) before taking substantive action.

The initial source of personal instructions is
[/config/.agents/README.md](/config/.agents/README.md).
...
* Read [/config/.agents/README.md](/config/.agents/README.md) if it exists
