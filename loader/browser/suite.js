...
var getSlimePart = function(definition) {
	return getPartDescriptor("../../../../" + definition);
}

if (working) {
	suite.part("loader/browser/client.js", getPartDescriptor("../../../../loader/browser/client.api.html"));
	suite.part("$api", getPartDescriptor("../../../../loader/$api.api.html"));
