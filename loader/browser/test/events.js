...
(
	/**
	 * @param { slime.loader.Export<slime.runtime.browser.test.events.Exports> } $export
	 */
	function($export) {
		var it = (
			/**
			 *
			 * @returns { slime.runtime.browser.test.events.Exports }
			 */
			function() {
				...
				return {
					click: eventFunction("click",MouseEvent,{
						bubbles: true,
						cancelable: true,
						//	TODO	should detail be 1?
						detail: 1
					}),
					mousedown: function(element,p) {
						if (element["disabled"]) debugger;
