...
(
	function(
		...
		tests.types.Database = function(database: slime.fifty.test.data.shopping.Database) {
		...
		tests.types.Exports = function(exports: slime.fifty.test.data.shopping.Exports) {
		...
		tests.suite = function() {
			var module: slime.fifty.test.data.shopping.Exports = $loader.module("module.js");
