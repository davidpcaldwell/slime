...
if (parameters.options.serve) {
	...
	jsh.shell.console("jrunscript " + httpProxy +  + " rhino/jrunscript/api.js jsh https://bitbucket.org/api/1.0/repositories/davidpcaldwell/slime/raw/local/jsh/test/jsh-data.jsh.js");
	jsh.shell.console("");
